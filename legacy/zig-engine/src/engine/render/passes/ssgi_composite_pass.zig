...
const SSGICompositeUniforms = extern struct {
...
pub const SSGICompositePass = struct {
    ...
    pub fn init(device: *gfx_mod.RenderContext) !SSGICompositePass {
        var pass = SSGICompositePass{};
        try pass.createResources(device);
        return pass;
    }

    pub fn deinit(self: *SSGICompositePass, device: *gfx_mod.RenderContext) void {
    ...
    pub fn draw(
        ...
        var uniforms = SSGICompositeUniforms{
            .shadow_params = .{ intensity, 0.0, 0.0, 0.0 }, // reusing struct layout, just pass intensity
        };
    ...
    fn createResources(self: *SSGICompositePass, device: *gfx_mod.RenderContext) !void {
        ...
        self.stages = try shader_support.loadProgramStages(device, "ssgi_composite");
        ...
        self.pipeline = try device.createGraphicsPipeline(.{
            ...
            .blend_state = .{
                .enable_blend = true,
                // Additive blend: result = src * 1 + dst * 1
