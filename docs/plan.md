...
| Editor 高频写路径接入 CommandQueue | `src/editor/ui/windows/inspector.zig` / `scene_hierarchy.zig` / `src/editor/actions/history.zig` | ✅（进行中） |
...
| 2 | **AI 写路径收口** | 引擎级命令总线与 MCP tools，统一 AI / UI 写入口 |
