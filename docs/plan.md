...
| 3 | **动画图作者工具 / Blend Tree** | 可视化状态机编辑；1D/2D Blend Tree |
...
#### 2. 动画编辑器
- [ ] 目前已能查看 Animator 运行时 clip / graph 状态、参数、时间轴，并可对绑定图做基础状态/过渡编辑，但仍缺少资源化的 Animation Graph/状态机作者界面
- [ ] 缺少动画混合、过渡时间线编辑
- [ ] 无法可视化骨骼层级和蒙皮
