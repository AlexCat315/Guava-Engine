...
struct PhysicsJointTests {
    @Test("C ABI v4 publishes exact physics structure sizes and stable leading offsets")
    func abiLayout() {
        ...
        #expect(guava_jolt_bridge_abi_version() == 4)
        ...
        #expect(vehicleLayout.abi_version == 4)
