...
/// Volumetric fog pass migrated to RHI v2.
///
...
pub const VolumetricFogPassV2 = struct {
    ...
    /// Encode and submit volumetric fog pass via v2 command buffer.
    pub fn execute(
        ...
        const shadow_sampler_set = try device.createBindingSetCached(layouts.shadow_sampler_layout, .{
            ...
            .label = "fog_v2_shadow_sampler_set",
        });
