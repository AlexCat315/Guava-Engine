...
/// Screen-Space Reflections pass migrated to RHI v2.
///
...
pub const SSRPassV2 = struct {
    ...
    /// Encode and submit the SSR pass via v2 command buffer.
    pub fn execute(
