...
pub const GizmoPass = struct {
    ...
    fn drawTranslateAxes(
        ...
        self.drawShape(device, frame, pass, self.translate_arrow_vertex_buffer.?, 0, 6, view_projection, model, axisColor(.x, constrained_axis, mode), stats);
        self.drawShape(device, frame, pass, self.translate_arrow_vertex_buffer.?, 6, 6, view_projection, model, axisColor(.y, constrained_axis, mode), stats);
        self.drawShape(device, frame, pass, self.translate_arrow_vertex_buffer.?, 12, 6, view_projection, model, axisColor(.z, constrained_axis, mode), stats);
    }
    ...
    fn drawScaleAxes(
        ...
        const model = composeModelMatrix(translation, rotation, .{ gizmo_scale, gizmo_scale, gizmo_scale }, .{ 0.0, 0.0, 0.0 });
        self.drawShape(device, frame, pass, self.axis_vertex_buffer.?, 0, 2, view_projection, model, axisColor(.x, constrained_axis, .scale), stats);
        self.drawShape(device, frame, pass, self.axis_vertex_buffer.?, 2, 2, view_projection, model, axisColor(.y, constrained_axis, .scale), stats);
        self.drawShape(device, frame, pass, self.axis_vertex_buffer.?, 4, 2, view_projection, model, axisColor(.z, constrained_axis, .scale), stats);
    }
    ...
    fn drawRotateRings(
        ...
        self.drawShape(device, frame, pass, self.ring_vertex_buffer.?, 0, ring_vertices.len, view_projection, x_model, axisColor(.x, constrained_axis, .rotate), stats);
        self.drawShape(device, frame, pass, self.ring_vertex_buffer.?, 0, ring_vertices.len, view_projection, y_model, axisColor(.y, constrained_axis, .rotate), stats);
        self.drawShape(device, frame, pass, self.ring_vertex_buffer.?, 0, ring_vertices.len, view_projection, z_model, axisColor(.z, constrained_axis, .rotate), stats);
    }
