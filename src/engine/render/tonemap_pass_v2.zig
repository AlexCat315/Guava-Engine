...
/// Tonemap post-process pass migrated to RHI v2.
///
/// Three binding sets:
...
pub const TonemapPassV2 = struct {
    ...
    pub fn createLayouts(device: *rhi.Device) !LayoutIds {
        ...
        const uniform_layout = try device.createBindingLayout(.{
            ...
            .label = "tonemap_v2_uniform_layout",
        });
