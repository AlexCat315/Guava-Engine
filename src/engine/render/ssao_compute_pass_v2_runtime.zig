...
pub const SSAOComputePassV2 = struct {
    ...
    pub fn init(device: *rhi_mod.RhiDevice) !SSAOComputePassV2 {
        var pass = SSAOComputePassV2{};
        try pass.createResources(device);
        return pass;
    }

    pub fn deinit(self: *SSAOComputePassV2, device: *rhi_mod.RhiDevice) void {
    ...
    fn createResources(self: *SSAOComputePassV2, device: *rhi_mod.RhiDevice) !void {
