...
export interface RpcMethods {
  ...
  "assets.importModel": { params: { path: string }; result: Record<string, never> };
  ...
  "script.setEntityParameters": { params: { entityId: number; parameters: string; scriptIndex?: number }; result: Record<string, never> };
