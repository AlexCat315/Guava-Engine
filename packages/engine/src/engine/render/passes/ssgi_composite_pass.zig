...
pub const SSGICompositePass = struct {
    ...
    pub fn init(device: *rhi_mod.RhiDevice) !SSGICompositePass {
        var pass = SSGICompositePass{};
        try pass.createResources(device);
        return pass;
    }

    pub fn deinit(self: *SSGICompositePass, device: *rhi_mod.RhiDevice) void {
    ...
    fn createResources(self: *SSGICompositePass, device: *rhi_mod.RhiDevice) !void {
