...
pub const SSGICompositePass = struct {
    ...
    pub fn init(device: *gfx_mod.GfxDevice) !SSGICompositePass {
        var pass = SSGICompositePass{};
        try pass.createResources(device);
        return pass;
    }

    pub fn deinit(self: *SSGICompositePass, device: *gfx_mod.GfxDevice) void {
    ...
    fn createResources(self: *SSGICompositePass, device: *gfx_mod.GfxDevice) !void {
