...
pub const FxaaPass = struct {
    ...
    pub fn init(device: *gfx_mod.RenderContext) !FxaaPass {
        var pass = FxaaPass{};
        try pass.createResources(device);
        return pass;
    }

    pub fn deinit(self: *FxaaPass, device: *gfx_mod.RenderContext) void {
    ...
    pub fn isReady(self: *const FxaaPass) bool {
    ...
    pub fn syncTexture(
        ...
        self.bound_input_handle = input_handle;
    }
    ...
    fn createResources(self: *FxaaPass, device: *gfx_mod.RenderContext) !void {
        ...
        self.stages = try shader_support.loadProgramStages(device, "fxaa");
