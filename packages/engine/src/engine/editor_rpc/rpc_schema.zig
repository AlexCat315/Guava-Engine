...
pub const Methods = struct {
    ...
    pub const @"animation.getState" = struct {
        ...
        pub const Result = struct {
            ...
            states: ?[]const SharedTypes.AnimGraphState = null,
            transitions: ?[]const SharedTypes.AnimGraphTransition = null,
            parameters: ?[]const SharedTypes.AnimGraphParameter = null,
            clipTracks: ?[]const SharedTypes.AnimClipTrack = null,
