...
- 路径追踪重写：CPU / Metal 已同步 GGX VNDF + NEE / MIS + Principled BSDF + HDR `.hdr` 环境重要性采样 + 俄罗斯轮盘 + 8x8 tile adaptive sampling；Editor PNG 导出已支持 `albedo / normal` AOV sidecar + AOV-guided denoise，待补 OIDN / MPS / 序列导出
