...
- 引擎级 `CommandQueue` 已落地最小闭环，Inspector / Hierarchy / 基础创建路径已复用；MCP 已支持 `stage/apply/discard` staged transaction，编辑器 viewport 已有 ghost preview pins、apply/discard overlay，以及同视口的 staged wireframe ghost pass
